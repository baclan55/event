...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return (
    <html lang="ru">
      <head>
        <link rel="stylesheet" href="/css/site-1.css?v=4" />
        <link rel="stylesheet" href="/css/site-2.css?v=4" />
        <link rel="stylesheet" href="/css/site-3.css?v=4" />
        <link rel="stylesheet" href="/css/site-4.css?v=4" />
      </head>
      <body>
        <script
