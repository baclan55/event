...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return (
    <html lang="ru">
      <head>
        <link rel="stylesheet" href="/css/site-1.css?v=54" />
        <link rel="stylesheet" href="/css/site-2.css?v=54" />
        <link rel="stylesheet" href="/css/site-3.css?v=54" />
        <link rel="stylesheet" href="/css/site-4.css?v=54" />
        <link rel="stylesheet" href="/css/site-5.css?v=54" />
        <link rel="stylesheet" href="/css/site-6.css?v=54" />
        <link rel="stylesheet" href="/css/site-7.css?v=54" />
        <link rel="stylesheet" href="/css/site-8.css?v=54" />
      </head>
      <body>
        <script
