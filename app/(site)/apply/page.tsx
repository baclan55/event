...
export default function ApplyPage() {
  ...
  if (!user) return <><div className="site-page-head"><h1>Заявка в отдел</h1><p>Для отправки анкеты необходимо войти через Discord.</p></div><div className="qform"><div className="qform-card"><button className="btn btn-discord" onClick={() => { window.location.href = '/api/auth/discord?consent=1&returnTo=apply'; }}>Войти через Discord</button></div></div></>;
